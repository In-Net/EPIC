...
(* --fair algorithm main {
  variables
    ...
    res = [i \in REQ_SET |-> SumSet({req_val[c, i] : c \in CLIENT_SET})];
    __active_threads = [__n \in SWITCH_SET |-> 4] @@ [__n \in CLIENT_SET |-> 3];
    ...
    nak_sent = [__n \in SWITCH_SET |-> ([ch \in ChildrenOf(__n) \cup {ParentOf(__n)} |-> FALSE])];
  ...
  define {
    ...
    ParentOf(nid) == IF nid = ROOT THEN ROOT ELSE nid \div 2
    ChildrenOf(nid) == {2 * nid, 2 * nid + 1}
...
\*     };
  ...
  L_ClientRetx:
    while(base[__Node(self)] < REQ_NUM) {
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
      else {
        with (
        ...
        with (
          ...
          if (pkt.type = REQ) {
                  ...
                  with (
                    ...
                    if (IsCompleted(__Node(self), AggEPsn[__Node(self)], (pkt).psn)) {
                      if (__Node(self) # ROOT) {
                        ...
                        recirc_pkts[__Node(self)] := Append(recirc_pkts[__Node(self)], (MakePktWithValue(RES, __Node(self), __Node(self), (pkt).psn, AggBuffer[__Node(self)][idx])));
                      };
                    };
                  }
                };
            ...
            with (
              ...
              if ((pkt).psn < BEPsn[__Node(self)]) {
                with (
                  ...
                  __Assert(__Node(self) # ROOT, "SwitchRes: root switch receives behind RES.");
                ...
                if (~nak_sent[__Node(self)][(pkt).src]) {
                  with (
                    ...
                    nak_sent[__Node(self)][(pkt).src] := TRUE;
                  }
                };
                else {
                  __Drop();
                ...
                nak_sent[__Node(self)][(pkt).src] := FALSE;
                if ((pkt).psn >= BPsnStart[__Node(self)] + AGG_NUM) {
                  ...
                  if (__Node(self) # ROOT) {
                    ...
                    __Assert(AggPsnStart[__Node(self)] = (pkt).psn, "SwitchRes: root switch suffers inconsistent AggPsnStart and BEPsn.");
                    AggBuffer[__Node(self)][idx] := 0;
                    AggPsnStart[__Node(self)] := AggPsnStart[__Node(self)] + 1;
                  };
                };
              };
            }
            ...
            with (
              ...
              if ((pkt).src = ParentOf(__Node(self))) {
                __Assert(__Node(self) # ROOT, "SwitchAck: root switch receives ACK from parent.");
            ...
            with (
              ...
              if ((pkt).src = ParentOf(__Node(self))) {
                with (
                  ...
                  __Assert(__Node(self) # ROOT, "SwitchNak: root switch receives NAK from parent.");
...
\*     };
  ...
  L_SwitchRetxReq:
    while(AggPsnStart[__Node(self)] < REQ_NUM) {
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
      else {
        with (
          max_psn = MinEPsn(__Node(self), AggEPsn[__Node(self)]) - 1,
          ...
          if (__Node(self) # ROOT) {
            ...
            with (
              pkts = [i \in 1 .. Len(range_seq) |-> MakePktWithValue(RES, __Node(self), __Node(self), range_seq[i], AggBuffer[__Node(self)][Idx(range_seq[i])])],
            ) {
              recirc_pkts[__Node(self)] := recirc_pkts[__Node(self)] \o (pkts);
            }
          };
...
\* BEGIN TRANSLATION (chksum(pcal) = "7c28162a" /\ chksum(tla) = "edf177f4")
VARIABLES pc, __net_buf, __max_loss, __max_out_of_order, __max_duplication, 
          req_val, res, __active_threads, AggEPsn, AggBuffer, AggPsnStart, 
          BEPsn, BBuffer, BPsnStart, REPsn, nak_sent, recirc_pkts, requests, 
          base, res_epsn
...
ProcSet == ((CLIENT_SET \X {"ClientInitSend"})) \cup ((CLIENT_SET \X {"ClientRecv"})) \cup ((CLIENT_SET \X {"ClientRetx"})) \cup ((SWITCH_SET \X {"SwitchRecv"})) \cup ((SWITCH_SET \X {"SwitchRecirc"})) \cup ((SWITCH_SET \X {"SwitchRetxReq"})) \cup ((SWITCH_SET \X {"SwitchRetxRes"}))
...
L_ClientInitSend(self) == /\ pc[self] = "L_ClientInitSend"
                          /\ IF __active_threads[__Node(self)] <= 0
                                ...
                                ELSE /\ LET end_idx == SmallerOf(WINDOW_SIZE, REQ_NUM) IN
                                                 ...
                                                 LET __h == __next_hop[__Node(self), __dst] IN
                                                   LET __pkts_ordered == __Set2OrderedSeq({([i \in 0 .. (end_idx - 1) |-> requests[__Node(self)][i]])[__i] : __i \in __keys}) IN
                                                     /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                          Assert(__b, 
                                                                 "Failure of assertion at line 126, column 7 of macro called at line 381, column 9.")
                          ...
                          /\ UNCHANGED << __max_duplication, req_val, res, 
                                          ...
                                          AggPsnStart, BEPsn, BBuffer, 
                                          BPsnStart, REPsn, nak_sent, 
                                          recirc_pkts, requests, res_epsn >>
...
L_ClientRecv(self) == /\ pc[self] = "L_ClientRecv"
                      /\ IF __active_threads[__Node(self)] <= 0
                            ...
                            ELSE /\ LET pkt == __Receive(__Node(self)) IN
                                      ...
                                      /\ IF pkt.type = ACK
                                            THEN /\ IF (pkt).psn > base[__Node(self)]
                                                                 ...
                                                                 LET end_idx == SmallerOf((pkt).psn + WINDOW_SIZE, REQ_NUM) IN
                                                                   /\ IF start_idx < end_idx
                                                                         THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropUnicast: empty buffer") IN
                                                                                   Assert(__b, 
                                                                                          "Failure of assertion at line 126, column 7 of macro called at line 407, column 19.")
                                                                         ...
                                                                         ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                   Assert(__b, 
                                                                                          "Failure of assertion at line 126, column 7 of macro called at line 410, column 19.")
                                                       ...
                                                       ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 126, column 7 of macro called at line 416, column 15.")
                                                            /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                            /\ UNCHANGED << __max_loss, 
                                                                            __max_out_of_order, 
                                                                            base >>
                                            ...
                                            ELSE /\ IF pkt.type = NAK
                                                       THEN /\ IF (pkt).psn >= base[__Node(self)]
                                                                  THEN /\ LET next == __next_hop[__Node(self), (requests[__Node(self)][(pkt).psn]).dst] IN
                                                                            IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (requests[__Node(self)][(pkt).psn]))
                                                                               THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                         Assert(__b, 
                                                                                                "Failure of assertion at line 126, column 7 of macro called at line 425, column 19.")
                                                                                    /\ LET __s == __Node(self) IN
                                                                               ...
                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                         Assert(__b, 
                                                                                                "Failure of assertion at line 126, column 7 of macro called at line 428, column 19.")
                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                    __max_out_of_order >>
                                                                  ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 433, column 15.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order >>
                                                            /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                            /\ UNCHANGED << __active_threads, 
                                                                            res_epsn >>
                                                       ELSE /\ IF pkt.type = RES
                                                                  THEN /\ LET __b == Assert(((pkt).value = res[(pkt).psn]), "ClientRes: incorrect result.") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 437, column 13.")
                                                                       /\ IF (pkt).psn = res_epsn[__Node(self)]
                                                                             THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))).dst] IN
                                                                                       ...
                                                                                       /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn'[__Node(self)]))))
                                                                                             THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 444, column 19.")
                                                                                                  /\ LET __s == __Node(self) IN
                                                                                             ...
                                                                                             ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 447, column 19.")
                                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                                  __max_out_of_order >>
                                                                                       /\ IF res_epsn'[__Node(self)] = REQ_NUM
                                                                             ...
                                                                             ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                       Assert(__b, 
                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 455, column 15.")
                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                  /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                  __max_out_of_order, 
                                                                  ...
                                                                  ELSE /\ LET __b == Assert(FALSE, "ClientRecv: unexpected packet type") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 459, column 13.")
                                                                       /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 460, column 13.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order, 
                      ...
                      /\ UNCHANGED << __max_duplication, req_val, res, AggEPsn, 
                                      AggBuffer, AggPsnStart, BEPsn, BBuffer, 
...
L_ClientRetx(self) == /\ pc[self] = "L_ClientRetx"
                                                      ...
                                                      LET __dst == ([i \in base[__Node(self)] .. (end_idx - 1) |-> requests[__Node(self)][i]])[CHOOSE __i \in __keys : TRUE].dst IN
                                                        LET __h == __next_hop[__Node(self), __dst] IN
                                                          LET __pkts_ordered == __Set2OrderedSeq({([i \in base[__Node(self)] .. (end_idx - 1) |-> requests[__Node(self)][i]])[__i] : __i \in __keys}) IN
                                                            /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 126, column 7 of macro called at line 482, column 11.")
                      ...
                      /\ UNCHANGED << __max_duplication, req_val, res, 
                                      __active_threads, AggEPsn, AggBuffer, 
                                      AggPsnStart, BEPsn, BBuffer, BPsnStart, 
                                      REPsn, nak_sent, recirc_pkts, requests, 
                                      base, res_epsn >>
                                                                   ...
                                                                   IF (pkt).psn < AggEPsn[__Node(self)][ch]
                                                                      THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ch), (AggEPsn[__Node(self)][ch]))).dst] IN
                                                                                IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ch), (AggEPsn[__Node(self)][ch]))))
                                                                                   THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                             Assert(__b, 
                                                                                                    "Failure of assertion at line 126, column 7 of macro called at line 512, column 21.")
                                                                                        /\ LET __s == __Node(self) IN
                                                                                   ...
                                                                                   ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                             Assert(__b, 
                                                                                                    "Failure of assertion at line 126, column 7 of macro called at line 515, column 21.")
                                                                                        /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                        /\ UNCHANGED << __max_loss, 
                                                                                                        __max_out_of_order >>
                                                                           /\ UNCHANGED << AggEPsn, 
                                                                                 ...
                                                                                 THEN /\ IF ~nak_sent[__Node(self)][ch]
                                                                                            THEN /\ LET next == __next_hop[__Node(self), (MakePkt((NAK), (__Node(self)), (ch), (AggEPsn[__Node(self)][ch]))).dst] IN
                                                                                                      /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((NAK), (__Node(self)), (ch), (AggEPsn[__Node(self)][ch]))))
                                                                                                            THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 525, column 23.")
                                                                                                                 /\ LET __s == __Node(self) IN
                                                                                                            ...
                                                                                                            ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 528, column 23.")
                                                                                                                 /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                 /\ UNCHANGED << __max_loss, 
                                                                                                                                 __max_out_of_order >>
                                                                                            ...
                                                                                            ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                      Assert(__b, 
                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 534, column 19.")
                                                                                                 /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                 /\ UNCHANGED << __max_loss, 
                                                                                                                 __max_out_of_order, 
                                                                                                                 nak_sent >>
                                                                                 ...
                                                                                 ELSE /\ nak_sent' = [nak_sent EXCEPT ![__Node(self)][ch] = FALSE]
                                                                                      /\ IF (pkt).psn >= AggPsnStart[__Node(self)] + AGG_NUM
                                                                                            THEN /\ TRUE
                                                                                                 /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                      Assert(__b, 
                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 541, column 19.")
                                                                                                 /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                 /\ UNCHANGED << __max_loss, 
                                                                                                                 __max_out_of_order, 
                                                                                                                 AggEPsn, 
                                                                                            ...
                                                                                            ELSE /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ch), (AggEPsn[__Node(self)][ch]))).dst] IN
                                                                                                      ...
                                                                                                      /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ch), (AggEPsn'[__Node(self)][ch]))))
                                                                                                            THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 550, column 23.")
                                                                                                                 /\ LET __s == __Node(self) IN
                                                                                                                      LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), (ch), (AggEPsn'[__Node(self)][ch])))).dst] IN
                                                                                                                        \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                                           /\ __max_out_of_order > 0
                                                                                                            ...
                                                                                                            ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 126, column 7 of macro called at line 553, column 23.")
                                                                                                                 /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                 /\ UNCHANGED << __max_loss, 
                                                                                                                                 __max_out_of_order >>
                                                                                                      /\ IF IsCompleted(__Node(self), AggEPsn'[__Node(self)], (pkt).psn)
                                                                                                            THEN /\ IF __Node(self) # ROOT
                                                                                                                       ...
                                                                                                                       ELSE /\ recirc_pkts' = [recirc_pkts EXCEPT ![__Node(self)] = Append(recirc_pkts[__Node(self)], (MakePktWithValue(RES, __Node(self), __Node(self), (pkt).psn, AggBuffer'[__Node(self)][idx])))]
                                                                                                            ELSE /\ TRUE
                                                                  ...
                                                                  THEN /\ LET idx == Idx((pkt).psn) IN
                                                                            IF (pkt).psn < BEPsn[__Node(self)]
                                                                               THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (BEPsn[__Node(self)]))).dst] IN
                                                                                         /\ LET __b == Assert((__Node(self) # ROOT), "SwitchRes: root switch receives behind RES.") IN
                                                                                              Assert(__b, 
                                                                                                     "Failure of assertion at line 126, column 7 of macro called at line 576, column 19.")
                                                                                         /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (BEPsn[__Node(self)]))))
                                                                                               THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 126, column 7 of macro called at line 578, column 21.")
                                                                                                    /\ LET __s == __Node(self) IN
                                                                                               ...
                                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 126, column 7 of macro called at line 581, column 21.")
                                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                                    __max_out_of_order >>
                                                                                    /\ UNCHANGED << AggBuffer, 
                                                                                                    ...
                                                                                                    recirc_pkts >>
                                                                               ELSE /\ IF (pkt).psn > BEPsn[__Node(self)]
                                                                                          THEN /\ IF ~nak_sent[__Node(self)][(pkt).src]
                                                                                                     THEN /\ LET next == __next_hop[__Node(self), (MakePkt((NAK), (__Node(self)), ((pkt).src), (BEPsn[__Node(self)]))).dst] IN
                                                                                                               /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((NAK), (__Node(self)), ((pkt).src), (BEPsn[__Node(self)]))))
                                                                                                                     THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                               Assert(__b, 
                                                                                                                                      "Failure of assertion at line 126, column 7 of macro called at line 591, column 23.")
                                                                                                                          /\ LET __s == __Node(self) IN
                                                                                                                     ...
                                                                                                                     ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                               Assert(__b, 
                                                                                                                                      "Failure of assertion at line 126, column 7 of macro called at line 594, column 23.")
                                                                                                                          /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                          /\ UNCHANGED << __max_loss, 
                                                                                                                                          __max_out_of_order >>
                                                                                                               /\ nak_sent' = [nak_sent EXCEPT ![__Node(self)][(pkt).src] = TRUE]
                                                                                                     ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                               Assert(__b, 
                                                                                                                      "Failure of assertion at line 126, column 7 of macro called at line 600, column 19.")
                                                                                                          /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                          /\ UNCHANGED << __max_loss, 
                                                                                                                          __max_out_of_order, 
                                                                                                                          nak_sent >>
                                                                                               /\ UNCHANGED << AggBuffer, 
                                                                                                               ...
                                                                                                               BBuffer, 
                                                                                                               recirc_pkts >>
                                                                                          ELSE /\ nak_sent' = [nak_sent EXCEPT ![__Node(self)][(pkt).src] = FALSE]
                                                                                               /\ IF (pkt).psn >= BPsnStart[__Node(self)] + AGG_NUM
                                                                                                     THEN /\ TRUE
                                                                                                          /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                               Assert(__b, 
                                                                                                                      "Failure of assertion at line 126, column 7 of macro called at line 607, column 19.")
                                                                                                          /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                          /\ UNCHANGED << __max_loss, 
                                                                                                                          __max_out_of_order, 
                                                                                                                          AggBuffer, 
                                                                                                     ...
                                                                                                     ELSE /\ BBuffer' = [BBuffer EXCEPT ![__Node(self)][idx] = (pkt).value]
                                                                                                          ...
                                                                                                          /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropMulticast: empty buffer") IN
                                                                                                               Assert(__b, 
                                                                                                                      "Failure of assertion at line 126, column 7 of macro called at line 612, column 19.")
                                                                                                                       ...
                                                                                                                       LET __possible_ooo_1 == __AllPossibleOutOfOrder(__unlost_dsts) IN
                                                                                                                         LET __possible_ooo_2 ==                  {__o \in __possible_ooo_1 :
                                                                                                                           ...
                                                                                                                           \E __ooo \in __possible_ooo_2:
                                                                                                                             ...
                                                                                                                             /\ __max_out_of_order' = __max_out_of_order - __PosCount(__ooo)
                                                                                                          /\ IF __Node(self) # ROOT
                                                                                                                THEN /\ recirc_pkts' = [recirc_pkts EXCEPT ![__Node(self)] = Append(recirc_pkts[__Node(self)], (MakePkt(ACK, __Node(self), (pkt).src, BEPsn'[__Node(self)])))]
                                                                                                                     /\ UNCHANGED << AggBuffer, 
                                                                                                                                     AggPsnStart >>
                                                                                                                ELSE /\ LET __b == Assert((AggPsnStart[__Node(self)] = (pkt).psn), "SwitchRes: root switch suffers inconsistent AggPsnStart and BEPsn.") IN
                                                                                                                          Assert(__b, 
                                                                                                                                 "Failure of assertion at line 126, column 7 of macro called at line 617, column 21.")
                                                                                                                     /\ AggBuffer' = [AggBuffer EXCEPT ![__Node(self)][idx] = 0]
                                                                                                                     /\ AggPsnStart' = [AggPsnStart EXCEPT ![__Node(self)] = AggPsnStart[__Node(self)] + 1]
                                                                                                                     /\ UNCHANGED recirc_pkts
                                                                       /\ UNCHANGED << BPsnStart, 
                                                                                       REPsn >>
                                                                  ELSE /\ IF pkt.type = ACK
                                                                             THEN /\ LET idx == Idx((pkt).psn) IN
                                                                                       /\ IF (pkt).src = ParentOf(__Node(self))
                                                                                             THEN /\ LET __b == Assert((__Node(self) # ROOT), "SwitchAck: root switch receives ACK from parent.") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 630, column 17.")
                                                                                                  /\ LET __b == Assert((\A ch \in ChildrenOf(__Node(self)) : AggEPsn[__Node(self)][ch] >= (pkt).psn), "SwitchAck: switch receives ACK for uncompleted aggregation.") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 631, column 17.")
                                                                                                  /\ LET __b == Assert(((pkt).psn <= AggPsnStart[__Node(self)] + AGG_NUM), "SwitchAck: ACK for unstarted aggregation.") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 632, column 17.")
                                                                                                  /\ IF (pkt).psn > AggPsnStart[__Node(self)]
                                                                                                  ...
                                                                                                  /\ UNCHANGED << BBuffer, 
                                                                                                                  BPsnStart, 
                                                                                                                  REPsn >>
                                                                                             ELSE /\ LET ch == (pkt).src IN
                                                                                                       /\ LET __b == Assert((BEPsn[__Node(self)] >= (pkt).psn), "SwitchAck: switch receives ACK for unreceived result.") IN
                                                                                                            Assert(__b, 
                                                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 646, column 19.")
                                                                                                       /\ IF (pkt).psn > REPsn[__Node(self)][ch]
                                                                                       ...
                                                                                       /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                            Assert(__b, 
                                                                                                   "Failure of assertion at line 126, column 7 of macro called at line 661, column 15.")
                                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                  /\ UNCHANGED recirc_pkts
                                                                             ELSE /\ IF pkt.type = NAK
                                                                                        THEN /\ LET idx == Idx((pkt).psn) IN
                                                                                                  /\ IF (pkt).src = ParentOf(__Node(self))
                                                                                                        THEN /\ LET max_psn == MinEPsn(__Node(self), AggEPsn[__Node(self)]) - 1 IN
                                                                                                                  LET range_seq == RangeToSeq(AggPsnStart[__Node(self)], max_psn) IN
                                                                                                                    LET pkts == [i \in 1 .. Len(range_seq) |-> MakePktWithValue(REQ, __Node(self), ParentOf(__Node(self)), range_seq[i], AggBuffer[__Node(self)][Idx(range_seq[i])])] IN
                                                                                                                      /\ LET __b == Assert((__Node(self) # ROOT), "SwitchNak: root switch receives NAK from parent.") IN
                                                                                                                           Assert(__b, 
                                                                                                                                  "Failure of assertion at line 126, column 7 of macro called at line 674, column 19.")
                                                                                                                      /\ LET __b == Assert(((pkt).psn = AggPsnStart[__Node(self)]), "SwitchNak: we currently do not consider out-of-order networks.") IN
                                                                                                                           Assert(__b, 
                                                                                                                                  "Failure of assertion at line 126, column 7 of macro called at line 675, column 19.")
                                                                                                                      /\ LET __b == Assert((IsCompleted(__Node(self), AggEPsn[__Node(self)], (pkt).psn)), "SwitchNak: NAK for uncompleted aggregation.") IN
                                                                                                                           Assert(__b, 
                                                                                                                                  "Failure of assertion at line 126, column 7 of macro called at line 676, column 19.")
                                                                                                                    ...
                                                                                                                    LET range_seq == RangeToSeq(REPsn[__Node(self)][ch], max_psn) IN
                                                                                                                      LET pkts == [i \in 1 .. Len(range_seq) |-> MakePktWithValue(RES, __Node(self), ch, range_seq[i], BBuffer[__Node(self)][Idx(range_seq[i])])] IN
                                                                                                                        /\ LET __b == Assert(((pkt).psn = REPsn[__Node(self)][ch]), "SwitchNak: we currently do not consider out-of-order networks.") IN
                                                                                                                             Assert(__b, 
                                                                                                                                    "Failure of assertion at line 126, column 7 of macro called at line 687, column 19.")
                                                                                                                        /\ recirc_pkts' = [recirc_pkts EXCEPT ![__Node(self)] = recirc_pkts[__Node(self)] \o (pkts)]
                                                                                                  /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 126, column 7 of macro called at line 691, column 15.")
                                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                        ELSE /\ LET __b == Assert(FALSE, "SwitchRecv: unexpected packet type") IN
                                                                                                  Assert(__b, 
                                                                                                         "Failure of assertion at line 126, column 7 of macro called at line 695, column 13.")
                                                                                             /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                  Assert(__b, 
                                                                                                         "Failure of assertion at line 126, column 7 of macro called at line 696, column 13.")
                                                                                             /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                             /\ UNCHANGED recirc_pkts
                                                                                  /\ UNCHANGED << AggBuffer, 
                                                                                                  AggPsnStart, 
                        ...
                        /\ IF ~SwitchCanTerminate(__Node(self))
                              ...
                              ELSE /\ pc' = [pc EXCEPT ![self] = "Done"]
                                   /\ UNCHANGED << __net_buf, __max_loss, 
                                                   ...
                                                   __max_duplication, 
                                                   recirc_pkts >>
                        /\ UNCHANGED << req_val, res, __active_threads, 
                                        AggEPsn, AggBuffer, AggPsnStart, BEPsn, 
...
L_SwitchRetxReq(self) == /\ pc[self] = "L_SwitchRetxReq"
                         /\ IF AggPsnStart[__Node(self)] < REQ_NUM
                               THEN /\ IF __active_threads[__Node(self)] <= 0
                                          THEN /\ pc' = [pc EXCEPT ![self] = "Done"]
                                               /\ UNCHANGED recirc_pkts
                                          ELSE /\ LET max_psn == MinEPsn(__Node(self), AggEPsn[__Node(self)]) - 1 IN
                                                    LET range_seq == RangeToSeq(AggPsnStart[__Node(self)], max_psn) IN
                                                      ...
                                                      /\ IF __Node(self) # ROOT
                                                            THEN /\ LET pkts == [i \in 1 .. Len(range_seq) |-> MakePktWithValue(REQ, __Node(self), ParentOf(__Node(self)), range_seq[i], AggBuffer[__Node(self)][Idx(range_seq[i])])] IN
                                                                      recirc_pkts' = [recirc_pkts EXCEPT ![__Node(self)] = recirc_pkts[__Node(self)] \o (pkts)]
                                                            ELSE /\ LET pkts == [i \in 1 .. Len(range_seq) |-> MakePktWithValue(RES, __Node(self), __Node(self), range_seq[i], AggBuffer[__Node(self)][Idx(range_seq[i])])] IN
                                                                      recirc_pkts' = [recirc_pkts EXCEPT ![__Node(self)] = recirc_pkts[__Node(self)] \o (pkts)]
                         ...
                         /\ UNCHANGED << __net_buf, __max_loss, 
                                         ...
                                         req_val, res, __active_threads, 
                                         AggEPsn, AggBuffer, AggPsnStart, 
                                         BEPsn, BBuffer, BPsnStart, REPsn, 
                                         nak_sent, requests, base, res_epsn >>
