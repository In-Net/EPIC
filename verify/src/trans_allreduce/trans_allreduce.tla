      ...
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
        ...
        with (
          ...
          if (pkt.type = REQ) {
              ...
              if ((pkt).psn < ePSN[__Node(self)][ch]) {
                if (IsCompleted(__Node(self), ArrState[__Node(self)], (pkt).psn)) {
                  if (__Node(self) # ROOT) {
                    ...
                    __DropMulticast(MakePktWithValue(RES, __Node(self), __Node(self), (pkt).psn, AggBuffer[__Node(self)][idx]), ChildrenOf(__Node(self)));
                  };
                };
                else {
                  __Drop();
            ...
            with (
              next = __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))).dst],
            ) {
              __Assert((pkt).src \in ChildrenOf(__Node(self)), "SwitchAck: switch receives ACK from non-child.");
              if (~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))) {
                __DropSend((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))));
              };
              else {
                __Drop();
              };
...
\* BEGIN TRANSLATION (chksum(pcal) = "7c28162a" /\ chksum(tla) = "a4b141ad")
                                                 ...
                                                 LET __h == __next_hop[__Node(self), __dst] IN
                                                   LET __pkts_ordered == __Set2OrderedSeq({([i \in 0 .. (end_idx - 1) |-> requests[__Node(self)][i]])[__i] : __i \in __keys}) IN
                                                     /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                          Assert(__b, 
                                                                 "Failure of assertion at line 115, column 7 of macro called at line 370, column 9.")
                            ...
                            ELSE /\ LET pkt == __Receive(__Node(self)) IN
                                      ...
                                      /\ IF pkt.type = RES
                                            THEN /\ LET __b == Assert(((pkt).value = res[(pkt).psn]), "ClientRes: incorrect result.") IN
                                                      Assert(__b, 
                                                             "Failure of assertion at line 115, column 7 of macro called at line 390, column 13.")
                                                 /\ IF (pkt).psn < res_epsn[__Node(self)]
                                                       THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))).dst] IN
                                                                 IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))))
                                                                    THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                              Assert(__b, 
                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 396, column 19.")
                                                                    ...
                                                                    ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                              Assert(__b, 
                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 399, column 19.")
                                                       ...
                                                       ELSE /\ IF (pkt).psn = res_epsn[__Node(self)]
                                                                  THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))).dst] IN
                                                                            ...
                                                                            /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn'[__Node(self)]))))
                                                                                  THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                            Assert(__b, 
                                                                                                   "Failure of assertion at line 115, column 7 of macro called at line 409, column 19.")
                                                                                       /\ LET __s == __Node(self) IN
                                                                                            LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn'[__Node(self)])))).dst] IN
                                                                                              \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                 /\ __max_out_of_order > 0
                                                                                  ...
                                                                                  ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                            Assert(__b, 
                                                                                                   "Failure of assertion at line 115, column 7 of macro called at line 412, column 19.")
                                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                       /\ UNCHANGED << __max_loss, 
                                                                                                       __max_out_of_order >>
                                                                  ELSE /\ TRUE
                                                                       /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 115, column 7 of macro called at line 418, column 15.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order, 
                                                                                       res_epsn >>
                                            ...
                                            ELSE /\ IF pkt.type = ACK
                                                       THEN /\ IF (pkt).psn > base[__Node(self)]
                                                                            ...
                                                                            LET end_idx == SmallerOf((pkt).psn + WINDOW_SIZE, REQ_NUM) IN
                                                                              /\ IF start_idx < end_idx
                                                                                    THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropUnicast: empty buffer") IN
                                                                                              Assert(__b, 
                                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 428, column 19.")
                                                                                    ...
                                                                                    ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                              Assert(__b, 
                                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 431, column 19.")
                                                                                         /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                         /\ UNCHANGED << __max_loss, 
                                                                                                         __max_out_of_order >>
                                                                  ...
                                                                  ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 115, column 7 of macro called at line 440, column 15.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order, 
                                                       ...
                                                       ELSE /\ LET __b == Assert(FALSE, "ClientRecv: unexpected packet type") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 115, column 7 of macro called at line 444, column 13.")
                                                            /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 115, column 7 of macro called at line 445, column 13.")
                                                            /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                            /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                            /\ UNCHANGED << __max_loss, 
                                                                            __max_out_of_order, 
                                                        ...
                                                        LET __dst == pkts[CHOOSE __i \in __keys : TRUE].dst IN
                                                          LET __h == __next_hop[__Node(self), __dst] IN
                                                            LET __pkts_ordered == __Set2OrderedSeq({pkts[__i] : __i \in __keys}) IN
                                                              /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                                   Assert(__b, 
                                                                          "Failure of assertion at line 115, column 7 of macro called at line 468, column 11.")
                                                                 ...
                                                                 LET ch == (pkt).src IN
                                                                   IF (pkt).psn < ePSN[__Node(self)][ch]
                                                                      THEN /\ IF IsCompleted(__Node(self), ArrState[__Node(self)], (pkt).psn)
                                                                                 THEN /\ IF __Node(self) # ROOT
                                                                                            THEN /\ LET next == __next_hop[__Node(self), (MakePktWithValue((REQ), (__Node(self)), (ParentOf(__Node(self))), ((pkt).psn), (AggBuffer[__Node(self)][idx]))).dst] IN
                                                                                                      IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePktWithValue((REQ), (__Node(self)), (ParentOf(__Node(self))), ((pkt).psn), (AggBuffer[__Node(self)][idx]))))
                                                                                                         THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                   Assert(__b, 
                                                                                                                          "Failure of assertion at line 115, column 7 of macro called at line 499, column 25.")
                                                                                                              /\ LET __s == __Node(self) IN
                                                                                                         ...
                                                                                                         ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                   Assert(__b, 
                                                                                                                          "Failure of assertion at line 115, column 7 of macro called at line 502, column 25.")
                                                                                                              /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                              /\ UNCHANGED << __max_loss, 
                                                                                                                              __max_out_of_order >>
                                                                                            ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropMulticast: empty buffer") IN
                                                                                                      Assert(__b, 
                                                                                                             "Failure of assertion at line 115, column 7 of macro called at line 507, column 21.")
                                                                                                 ...
                                                                                                 /\ LET __b == Assert((__Node(self) \notin (ChildrenOf(__Node(self)))), "DropMulticast: self in destinations") IN
                                                                                                      Assert(__b, 
                                                                                                             "Failure of assertion at line 115, column 7 of macro called at line 507, column 21.")
                                                                                                 /\ LET __pkts == [__dst \in (ChildrenOf(__Node(self))) |-> "dst" :> __dst @@ (MakePktWithValue(RES, __Node(self), __Node(self), (pkt).psn, AggBuffer[__Node(self)][idx]))] IN
                                                                                 ...
                                                                                 ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                           Assert(__b, 
                                                                                                  "Failure of assertion at line 115, column 7 of macro called at line 511, column 19.")
                                                                                      /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                      /\ UNCHANGED << __max_loss, 
                                                                                                      __max_out_of_order >>
                                                                           /\ UNCHANGED << ArrState, 
                                                                      ...
                                                                      ELSE /\ IF (pkt).psn > ePSN[__Node(self)][ch]
                                                                                 THEN /\ TRUE
                                                                                      /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                           Assert(__b, 
                                                                                                  "Failure of assertion at line 115, column 7 of macro called at line 516, column 17.")
                                                                                      /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                      /\ UNCHANGED << __max_loss, 
                                                                                                      __max_out_of_order, 
                                                                                                      ArrState, 
                                                                                 ...
                                                                                 ELSE /\ LET __b == Assert((ArrState[__Node(self)][idx, ch] = 0), "SwitchReq: switch receives sync but duplicated REQ.") IN
                                                                                           Assert(__b, 
                                                                                                  "Failure of assertion at line 115, column 7 of macro called at line 519, column 17.")
                                                                                            ...
                                                                                            THEN /\ IF __Node(self) # ROOT
                                                                                                       THEN /\ LET next == __next_hop[__Node(self), (MakePktWithValue((REQ), (__Node(self)), (ParentOf(__Node(self))), ((pkt).psn), (AggBuffer'[__Node(self)][idx]))).dst] IN
                                                                                                                 IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePktWithValue((REQ), (__Node(self)), (ParentOf(__Node(self))), ((pkt).psn), (AggBuffer'[__Node(self)][idx]))))
                                                                                                                    THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                              Assert(__b, 
                                                                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 529, column 25.")
                                                                                                                         /\ LET __s == __Node(self) IN
                                                                                                                              LET __h == __next_hop[__s, ((MakePktWithValue((REQ), (__Node(self)), (ParentOf(__Node(self))), ((pkt).psn), (AggBuffer'[__Node(self)][idx])))).dst] IN
                                                                                                                                \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                                                   /\ __max_out_of_order > 0
                                                                                                                    ...
                                                                                                                    ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                              Assert(__b, 
                                                                                                                                     "Failure of assertion at line 115, column 7 of macro called at line 532, column 25.")
                                                                                                                         /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                         /\ UNCHANGED << __max_loss, 
                                                                                                                                         __max_out_of_order >>
                                                                                                       ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropMulticast: empty buffer") IN
                                                                                                                 Assert(__b, 
                                                                                                                        "Failure of assertion at line 115, column 7 of macro called at line 537, column 21.")
                                                                                                            /\ LET __b == Assert(((ChildrenOf(__Node(self))) \subseteq __links[__Node(self)]), "DropMulticast: invalid destinations") IN
                                                                                                                 Assert(__b, 
                                                                                                                        "Failure of assertion at line 115, column 7 of macro called at line 537, column 21.")
                                                                                                            /\ LET __b == Assert((__Node(self) \notin (ChildrenOf(__Node(self)))), "DropMulticast: self in destinations") IN
                                                                                    ...
                                                                                    LET __possible_ooo_1 == __AllPossibleOutOfOrder(__unlost_dsts) IN
                                                                                      LET __possible_ooo_2 ==                  {__o \in __possible_ooo_1 :
                                                                                        ...
                                                                                        \E __ooo \in __possible_ooo_2:
                                                                                          ...
                                                                                          /\ __max_out_of_order' = __max_out_of_order - __PosCount(__ooo)
                                                                  ELSE /\ IF pkt.type = ACK
                                                                             THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))).dst] IN
                                                                                       /\ LET __b == Assert(((pkt).src \in ChildrenOf(__Node(self))), "SwitchAck: switch receives ACK from non-child.") IN
                                                                                            Assert(__b, 
                                                                                                   "Failure of assertion at line 115, column 7 of macro called at line 553, column 15.")
                                                                                       /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))
                                                                                             THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 115, column 7 of macro called at line 555, column 17.")
                                                                                                  /\ LET __s == __Node(self) IN
                                                                                                       LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn)))).dst] IN
                                                                                                         \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                            /\ __max_out_of_order > 0
                                                                                                            /\ __OutOfOrderRange(__net_buf[__h]) # {}
                                                                                                            /\ \E __pos \in __OutOfOrderRange(__net_buf[__h]):
                                                                                                                 IF __s = __h
                                                                                                                    THEN /\ __net_buf' = [__net_buf EXCEPT ![__h] = Tail(__InsertAtEnd(@, __pos, ((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))))]
                                                                                                                    ELSE /\ __net_buf' = [__net_buf EXCEPT ![__h] = __InsertAtEnd(@, __pos, ((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))),
                                                                                                                                                           ![__s] = Tail(@)]
                                                                                                            /\ __max_out_of_order' = __max_out_of_order - 1
                                                                                                            /\ UNCHANGED __max_loss
                                                                                                         \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                            ...
                                                                                                            /\ UNCHANGED __max_out_of_order
                                                                                                         \/ /\ IF __s = __h
                                                                                                                  THEN /\ __net_buf' = [__net_buf EXCEPT ![__h] = Tail(Append(@, ((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))))]
                                                                                                                  ELSE /\ __net_buf' = [__net_buf EXCEPT ![__h] = Append(@, ((MakePkt((ACK), (__Node(self)), ((pkt).src), ((pkt).psn))))),
                                                                                                                                                         ![__s] = Tail(@)]
                                                                                                            /\ UNCHANGED <<__max_loss, __max_out_of_order>>
                                                                                             ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 115, column 7 of macro called at line 558, column 17.")
                                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                                  __max_out_of_order >>
                                                                             ELSE /\ LET __b == Assert(FALSE, "SwitchRecv: unexpected packet type") IN
                                                                                       Assert(__b, 
                                                                                              "Failure of assertion at line 115, column 7 of macro called at line 563, column 13.")
                                                                                  /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                       Assert(__b, 
                                                                                              "Failure of assertion at line 115, column 7 of macro called at line 564, column 13.")
                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                  __max_out_of_order >>
                                                            /\ UNCHANGED << ArrState, 
...
ClientBaseInv == \A nid \in CLIENT_SET : base[nid] <= res_epsn[nid]
