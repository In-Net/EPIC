...
(* --fair algorithm main {
  variables
    ...
    eepsn = [__n \in SWITCH_SET |-> ([ch \in ChildrenOf(__n) |-> 1])];
    min_eepsn = [__n \in SWITCH_SET |-> (1)];
  ...
  define {
    ...
    Idx(psn) == psn % AGG_NUM
    MinEEPsn(nid) == Min(Range(eepsn[nid]))
    CanTerminate(nid) == \A c \in NODE_SET : c > nid => __NodeTerminated(c)
  }
  ...
  L_ClientRecv:
    while(TRUE) {
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
        ...
        if (__Node(self) # COMM_ROOT /\ CanTerminate(__Node(self))) {
          __Exit();
        };
        else {
          with (
    ...
    while(__Node(self) = COMM_ROOT /\ base < REQ_NUM) {
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
        ...
        with (
          ...
          pkts = [i \in base .. (end_idx - 1) |-> requests[i]],
        ) {
          __Wait(__net_buf[__Node(self)] = <<>>);
          __Wait(base >= 0);
...
\*     };
  ...
  L_SwitchRecv:
    while(~CanTerminate(__Node(self))) {
      if (__active_threads[__Node(self)] <= 0) { goto Done; };
      else {
        with (
          pkt = __Receive(__Node(self)),
          ...
          if (pkt.type = RES) {
            ...
            with (
              ...
              __Assert((pkt).src \in ChildrenOf(__Node(self)), "SwitchAck: switch receives ACK from non-child.");
              if ((pkt).psn < eepsn[__Node(self)][ch]) {
                if ((pkt).psn <= min_eepsn[__Node(self)]) {
                  with (
                    next = __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))).dst],
                  ) {
                    if (~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))) {
                      __DropSend((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))));
                    };
                    else {
                      __Drop();
                    };
                ...
                eepsn[__Node(self)][ch] := (pkt).psn + 1;
                if (\A c \in ChildrenOf(__Node(self)) : eepsn[__Node(self)][c] > min_eepsn[__Node(self)]) {
                  with (
                    next = __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))).dst],
                  ) {
                    min_eepsn[__Node(self)] := Min(Range(eepsn[__Node(self)]));
                    if (~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))) {
                      __DropSend((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))));
                    };
                    else {
...
\* BEGIN TRANSLATION (chksum(pcal) = "7c28162a" /\ chksum(tla) = "7cb94370")
VARIABLES pc, __net_buf, __max_loss, __max_out_of_order, __max_duplication, 
          res, requests, base, __active_threads, eepsn, min_eepsn, res_epsn
...
L_ClientInitSend(self) == /\ pc[self] = "L_ClientInitSend"
                                                            ...
                                                            LET __h == __next_hop[__Node(self), __dst] IN
                                                              LET __pkts_ordered == __Set2OrderedSeq({([i \in 0 .. (end_idx - 1) |-> requests[i]])[__i] : __i \in __keys}) IN
                                                                /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                                     Assert(__b, 
                                                                            "Failure of assertion at line 112, column 7 of macro called at line 368, column 11.")
                          ...
                          /\ UNCHANGED << __max_duplication, res, requests, 
                                          __active_threads, eepsn, min_eepsn, 
                                          res_epsn >>
...
L_ClientRecv(self) == /\ pc[self] = "L_ClientRecv"
                      /\ IF __active_threads[__Node(self)] <= 0
                            ...
                            ELSE /\ IF __Node(self) # COMM_ROOT /\ CanTerminate(__Node(self))
                                       ...
                                       ELSE /\ LET pkt == __Receive(__Node(self)) IN
                                                 ...
                                                 /\ IF pkt.type = RES
                                                       THEN /\ LET __b == Assert((__Node(self) # COMM_ROOT), "ClientRes: root client receives RES.") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 112, column 7 of macro called at line 393, column 15.")
                                                            /\ LET __b == Assert(((pkt).value = res[(pkt).psn]), "ClientRes: incorrect result.") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 112, column 7 of macro called at line 394, column 15.")
                                                            /\ IF (pkt).psn < res_epsn[__Node(self)]
                                                                  THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))).dst] IN
                                                                            IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))))
                                                                               THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                         Assert(__b, 
                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 400, column 21.")
                                                                               ...
                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                         Assert(__b, 
                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 403, column 21.")
                                                                  ...
                                                                  ELSE /\ IF (pkt).psn = res_epsn[__Node(self)]
                                                                             THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn[__Node(self)]))).dst] IN
                                                                                       ...
                                                                                       /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn'[__Node(self)]))))
                                                                                             THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 112, column 7 of macro called at line 413, column 21.")
                                                                                                  /\ LET __s == __Node(self) IN
                                                                                                       LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), ((pkt).src), (res_epsn'[__Node(self)])))).dst] IN
                                                                                                         \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                            /\ __max_out_of_order > 0
                                                                                             ...
                                                                                             ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                       Assert(__b, 
                                                                                                              "Failure of assertion at line 112, column 7 of macro called at line 416, column 21.")
                                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                                  __max_out_of_order >>
                                                                             ELSE /\ TRUE
                                                                                  /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                       Assert(__b, 
                                                                                              "Failure of assertion at line 112, column 7 of macro called at line 422, column 17.")
                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                  __max_out_of_order, 
                                                                                                  res_epsn >>
                                                       ...
                                                       ELSE /\ IF pkt.type = ACK
                                                                  THEN /\ LET __b == Assert((__Node(self) = COMM_ROOT), "ClientAck: non-root client receives ACK.") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 112, column 7 of macro called at line 426, column 15.")
                                                                       /\ IF (pkt).psn > base
                                                                                       ...
                                                                                       LET end_idx == SmallerOf((pkt).psn + WINDOW_SIZE, REQ_NUM) IN
                                                                                         /\ IF start_idx < end_idx
                                                                                               THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropUnicast: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 433, column 21.")
                                                                                               ...
                                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 436, column 21.")
                                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                                    __max_out_of_order >>
                                                                                         /\ base' = (pkt).psn
                                                                             ...
                                                                             ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                       Assert(__b, 
                                                                                              "Failure of assertion at line 112, column 7 of macro called at line 445, column 17.")
                                                                                  /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                  /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                                                  /\ UNCHANGED << __max_loss, 
                                                                                                  __max_out_of_order, 
                                                                  ...
                                                                  ELSE /\ LET __b == Assert(FALSE, "ClientRecv: unexpected packet type") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 112, column 7 of macro called at line 449, column 15.")
                                                                       /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 112, column 7 of macro called at line 450, column 15.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ pc' = [pc EXCEPT ![self] = "L_ClientRecv"]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order, 
                                                                                       ...
                                                                                       __active_threads >>
                                                            /\ UNCHANGED res_epsn
                      /\ UNCHANGED << __max_duplication, res, requests, eepsn, 
                                      min_eepsn >>
                      ...
                      /\ IF __Node(self) = COMM_ROOT /\ base < REQ_NUM
                            THEN /\ IF __active_threads[__Node(self)] <= 0
                                       ...
                                       ELSE /\ LET end_idx == SmallerOf(base + WINDOW_SIZE, REQ_NUM) IN
                                                 LET pkts == [i \in base .. (end_idx - 1) |-> requests[i]] IN
                                                   /\ __net_buf[__Node(self)] = <<>>
                                                   /\ base >= 0
                                                        ...
                                                        LET __dst == pkts[CHOOSE __i \in __keys : TRUE].dst IN
                                                          LET __h == __next_hop[__Node(self), __dst] IN
                                                            LET __pkts_ordered == __Set2OrderedSeq({pkts[__i] : __i \in __keys}) IN
                                                              /\ LET __b == Assert((Cardinality(__keys) > 0), "Unicast: empty packets") IN
                                                                   Assert(__b, 
                                                                          "Failure of assertion at line 112, column 7 of macro called at line 474, column 11.")
                                       ...
                                       ELSE /\ LET pkt == __Receive(__Node(self)) IN
                                                 ...
                                                 /\ IF pkt.type = RES
                                                       THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropMulticast: empty buffer") IN
                                                                 Assert(__b, 
                                                                        "Failure of assertion at line 112, column 7 of macro called at line 494, column 13.")
                                                       ...
                                                       ELSE /\ IF pkt.type = ACK
                                                                  THEN /\ LET idx == Idx((pkt).psn) IN
                                                                            LET ch == (pkt).src IN
                                                                              /\ LET __b == Assert(((pkt).src \in ChildrenOf(__Node(self))), "SwitchAck: switch receives ACK from non-child.") IN
                                                                                   Assert(__b, 
                                                                                          "Failure of assertion at line 112, column 7 of macro called at line 501, column 15.")
                                                                              /\ IF (pkt).psn < eepsn[__Node(self)][ch]
                                                                                    THEN /\ IF (pkt).psn <= min_eepsn[__Node(self)]
                                                                                               THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))).dst] IN
                                                                                                         IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))
                                                                                                            THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 112, column 7 of macro called at line 508, column 23.")
                                                                                                                 /\ LET __s == __Node(self) IN
                                                                                                                      LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1)))).dst] IN
                                                                                                                        \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                                           /\ __max_out_of_order > 0
                                                                                                                           /\ __OutOfOrderRange(__net_buf[__h]) # {}
                                                                                                                           /\ \E __pos \in __OutOfOrderRange(__net_buf[__h]):
                                                                                                                                IF __s = __h
                                                                                                                                   THEN /\ __net_buf' = [__net_buf EXCEPT ![__h] = Tail(__InsertAtEnd(@, __pos, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))))]
                                                                                                                                   ELSE /\ __net_buf' = [__net_buf EXCEPT ![__h] = __InsertAtEnd(@, __pos, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))),
                                                                                                                                                                          ![__s] = Tail(@)]
                                                                                                                           /\ __max_out_of_order' = __max_out_of_order - 1
                                                                                                                           /\ UNCHANGED __max_loss
                                                                                                                        \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                                           ...
                                                                                                                           /\ UNCHANGED __max_out_of_order
                                                                                                                        \/ /\ IF __s = __h
                                                                                                                                 THEN /\ __net_buf' = [__net_buf EXCEPT ![__h] = Tail(Append(@, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))))]
                                                                                                                                 ELSE /\ __net_buf' = [__net_buf EXCEPT ![__h] = Append(@, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))))),
                                                                                                                                                                        ![__s] = Tail(@)]
                                                                                                                           /\ UNCHANGED <<__max_loss, __max_out_of_order>>
                                                                                                            ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                      Assert(__b, 
                                                                                                                             "Failure of assertion at line 112, column 7 of macro called at line 511, column 23.")
                                                                                                                 /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                 /\ UNCHANGED << __max_loss, 
                                                                                                                                 __max_out_of_order >>
                                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 516, column 19.")
                                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                                    __max_out_of_order >>
                                                                                         /\ UNCHANGED << eepsn, 
                                                                                                         min_eepsn >>
                                                                                    ELSE /\ eepsn' = [eepsn EXCEPT ![__Node(self)][ch] = (pkt).psn + 1]
                                                                                         /\ IF \A c \in ChildrenOf(__Node(self)) : eepsn'[__Node(self)][c] > min_eepsn[__Node(self)]
                                                                                               THEN /\ LET next == __next_hop[__Node(self), (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn[__Node(self)] - 1))).dst] IN
                                                                                                         /\ min_eepsn' = [min_eepsn EXCEPT ![__Node(self)] = Min(Range(eepsn'[__Node(self)]))]
                                                                                                         /\ IF ~__NodeTerminated(next) /\ ~Contains(__net_buf[next], (MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn'[__Node(self)] - 1))))
                                                                                                               THEN /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "DropSend: empty buffer") IN
                                                                                                                         Assert(__b, 
                                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 527, column 23.")
                                                                                                                    /\ LET __s == __Node(self) IN
                                                                                                                         LET __h == __next_hop[__s, ((MakePkt((ACK), (__Node(self)), (ParentOf(__Node(self))), (min_eepsn'[__Node(self)] - 1)))).dst] IN
                                                                                                                           \/ /\ __IsUnreliableLink(__Node(self), __h)
                                                                                                                              /\ __max_out_of_order > 0
                                                                                                               ...
                                                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                                         Assert(__b, 
                                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 530, column 23.")
                                                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                                                    __max_out_of_order >>
                                                                                               ELSE /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                                                         Assert(__b, 
                                                                                                                "Failure of assertion at line 112, column 7 of macro called at line 535, column 19.")
                                                                                                    /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                                                    /\ UNCHANGED << __max_loss, 
                                                                                                                    __max_out_of_order, 
                                                                                                                    min_eepsn >>
                                                                  ELSE /\ LET __b == Assert(FALSE, "SwitchRecv: unexpected packet type") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 112, column 7 of macro called at line 541, column 13.")
                                                                       /\ LET __b == Assert((__net_buf[__Node(self)] # <<>>), "Drop: empty buffer") IN
                                                                            Assert(__b, 
                                                                                   "Failure of assertion at line 112, column 7 of macro called at line 542, column 13.")
                                                                       /\ __net_buf' = [__net_buf EXCEPT ![__Node(self)] = Tail(@)]
                                                                       /\ UNCHANGED << __max_loss, 
                                                                                       __max_out_of_order, 
                                                                                       eepsn, 
